...
__all__ = ['pi_monte_carlo_parallel_slow', 'pi_monte_carlo_parallel_fast']
...
def pi_monte_carlo(domain : int) -> float :
    ...
    return _pi(circle_points, square_points)

def pi_monte_carlo_parallel_slow(domain : int) -> float :
    '''
...
def pi_monte_carlo_parallel_fast(domain : int, batch_size : int) -> float :
